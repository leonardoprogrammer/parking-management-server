...
public class ResponseFullParkedVehicleDTO {
    ...
    public ResponseFullParkedVehicleDTO(UUID parkedVehicleId, UUID parkingId, String plate, String model, String color, String space, LocalDateTime entryDate, UUID checkinEmployeeId, String checkinEmployeeName, LocalDateTime checkoutDate, UUID checkoutEmployeeId, String checkoutEmployeeName, boolean paid, String amountPaid, String paymentMethod, LocalDateTime createdAt) {
